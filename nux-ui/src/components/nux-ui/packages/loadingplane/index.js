const install = function (Vue) {
  Vue.prototype.$showLoadingPlane = function (text) {
		nDiv.style.display = 'block'
  }
	Vue.prototype.$hideLoadingPlane = function (text) {
	...
	var cssStr = `#nux-loading-plane {
								...
								#nux-loading-plane .nux-loading-inner {
									width: 60px;
									height: 60px;
								...
								#nux-loading-plane .nux-loading-inner::after {
									content: "";
								...
								#nux-loading-plane .nux-loading-inner .dong {
	...
	// 给div和style添加模板内容
	nDiv.setAttribute('id', 'nux-loading-plane')
