...
//添加版本信息start jinux
const package_v = require(paths.appPackageJson);
const fs_v = require('fs');
let html_v = fs_v.readFileSync(paths.appHtml).toString();
